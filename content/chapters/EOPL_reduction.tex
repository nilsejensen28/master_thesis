...
\begin{claim}
    \label[claim]{claim:opposite_orientations}
...
\begin{proof}
    ...
    \begin{align*}
        S_1: \quad & (-1)^i \cdot [v_0, \dots, \hat{v_i}, \dots, \hat{v_j}, \dots, v_{d}] \\
        S_2: \quad & (-1)^j \cdot [v_0, \dots, \hat{v_j}, \dots, \hat{v_i}, \dots, v_{d}]
    \end{align*}
    ...
    \begin{align*}
        ...
        \text{$E$ in $S_2$ }: \quad & (-1)^j \cdot (-1)^i \cdot [v_0, \dots, \hat{v_j}, \dots, \hat{v_i}, \dots, v_{d-1}]
    \end{align*}
